---
description: "Mandatory execution rules for every Copilot session in the glass-overlay (GlassOverlay) repository."
applyTo: "**/*"
---
...
`GlassOverlay` is consumed as a remote SPM dependency by every
