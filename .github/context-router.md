...
This repository contains a single SwiftPM package (**GlassOverlay**),
...
> apply here — `GlassOverlay` is engineering infrastructure, not a
...
`GlassOverlay` is consumed by every `wichtelimwald/*` Apple app as a
