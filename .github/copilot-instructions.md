# GitHub Copilot – Instructions (glass-overlay / GlassOverlay)

Swift Package · macOS 14+ · iOS 17+ · Swift 5.9+.
This repository contains exactly **one** SwiftPM package: **GlassOverlay**.
...
`GlassOverlay` is a focused, reusable Swift package consumed by the
